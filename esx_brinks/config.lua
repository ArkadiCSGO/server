...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 67,
	BlipColor = 52,
	BlipName = "Vestiaire de "..Config.nameJobLabel,
  ...
  Vente = {
	Pos   = {x = 256.13024902344, y = 226.51995849609, z = 101.8757019043},
	Size  = {x = 5.0, y = 5.0, z = 0.8},
	Color = {r = 11, g = 203, b = 159},
	Type  = 1,
	BlipSprite = 67,
	BlipColor = 52,
	BlipName = "Dépot de Fond",

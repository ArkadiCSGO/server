...
TriggerEvent('esx_society:registerSociety', 'banker', 'Banquier', 'society_banker', 'society_banker', 'society_banker', {type = 'private'})
...
TriggerEvent('cron:runAt', 0, 1, CalculateBankSavings)

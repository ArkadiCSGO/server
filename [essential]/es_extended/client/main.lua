...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlPressed(0, Keys["F1"]) and GetLastInputMethod(2) and not isDead and not ESX.UI.Menu.IsOpen('default', 'es_extended', 'inventory') and (GetGameTimer() - GUI.Time) > 150 then
      ESX.ShowInventory()

Locales['fr'] = {
  ...
  ['threw_weapon'] = 'tu as ~r~jeter~s~ ~y~1x~s~ ~b~%s~s~ avec ~o~%sx~s~ munitions!',
  ['gave_weapon'] = 'tu as donné ~y~1x~s~ ~b~%s~s~ avec ~o~%sx~s~ munitions',--to ~y~%s~s~.',
  ['recived_weapon'] = 'tu as reçue ~y~1x~s~ ~b~%s~s~ avec ~o~%sx~s~ munitions',-- from ~b~%s~s~.',
  ['gave_ammo'] = 'tu as donné ~o~%sx~s~ munitions',-- to ~y~%s~s~.',
  ['recived_ammo'] = 'tu as reçue ~o~%sx~s~ minutions',-- from ~b~%s~s~.',
  ...
  ['ex_inv_lim'] = 'action impossible, depassement de la limite ~b~d\'inventaire',
  ['yougave'] = 'vous lui avez donné',
